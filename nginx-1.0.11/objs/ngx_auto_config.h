#define NGX_CONFIGURE " --add-module=../nginx_mod_h264_streaming-2.2.7/ --prefix=/opt/local --conf-path=etc/nginx/nginx.conf --sbin-path=sbin/ --with-http_ssl_module"
